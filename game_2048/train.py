...
if __name__ == '__main__':
    def game_2048_factory() -> Game2048AI:
        return Game2048AI(input_size=Game2048Wrapper().input_size, hidden_size=10, output_size=Game2048Wrapper().output_size)
    ...
    result = train(Game2048Wrapper, game_2048_factory, 25, 128, 0.2, 0.1, save_rate=0.2)
